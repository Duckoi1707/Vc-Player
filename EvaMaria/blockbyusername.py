...
@Client.on_message(filters.@Client.on_message(filters.command(["block"], prefixes=f"{HNDLR}"))
async def block_True(client: Client, message: Message):
    try:
        ...
        await message.reply_text(f"<b>😨 Ooops:</b> <code>{e}</code>")


@Client.on_message(filters.@Client.on_message(filters.command(["unblock"], prefixes=f"{HNDLR}"))
async def unblock(client: Client, message: Message):
    try:
        ...
        await message.reply_text(f"<b>😰 Oops:</b> <code>{e}</code>")
