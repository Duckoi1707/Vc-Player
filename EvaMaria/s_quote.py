...
@Client.on_message(
    filters.command(["fq", "fakequote"], prefixes=f"{HNDLR}"))
async def fake_quote_cmd(client: Client, message: types.Message):
    if not message.reply_to_message:
        return await message.reply_textt("<b>Chỉ định thông báo cho báo giá giả mạo</b>")
    ...
    if not fake_quote_text:
        return await message.reply_text("<b>Văn bản trích dẫn giả trống</b>")
